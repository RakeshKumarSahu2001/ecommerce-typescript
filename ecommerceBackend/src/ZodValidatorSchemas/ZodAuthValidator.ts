...
//Zod check email for password update
export const ZodEmailCheckValidator = z.object({
    email: z.string({ required_error: "Email is required to reset the password" }).trim()
})

export type ZodEmailCheckSchemaType = z.infer<typeof ZodEmailCheckValidator>

//Zod reset password
export const ZodResetPasswordValidator = z.object({
    email: z.string({ required_error: "email is required to reset the password." }),
    otp: z.string({ required_error: "OTP is required to reset the password." }),
    password: z.string({ required_error: "Password is required to reset the password." })
})

export type ZodResetPasswordSchemaType = z.infer<typeof ZodResetPasswordValidator>
