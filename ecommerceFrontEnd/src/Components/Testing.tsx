    ...
    return (
        <div className="bg-white">
            <div className="pt-6">
                ...
                {/* Image gallery */}
                <div className="mx-auto max-w-2xl lg:grid lg:max-w-7xl grid-cols-[400px_minmax(850px,_1fr)] lg:gap-x-6">
                    <div className="sticky rounded-lg flex flex-row justify-center gap-2">
                        <div className='flex flex-col w-[15em]'>
                            <div className="w-20 h-20"><img src={product.images[1].src} alt={product.images[1].alt} className='aspect-square w-auto' /></div>
                            <div className="w-20 h-20"><img src={product.images[2].src} alt={product.images[2].alt} className='aspect-square w-auto' /></div>
                            <div className="w-20 h-20"><img src={product.images[3].src} alt={product.images[3].alt} className='aspect-square w-auto' /></div>
                            <div className="w-20 h-20"><img src={product.images[0].src} alt={product.images[0].alt} className='aspect-square w-auto' /></div>
                        </div>
                        <div> <img
